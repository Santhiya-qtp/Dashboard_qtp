...
export const DataProvider = ({ children }) => {
  ...
  const [perRequests, setPerRequests] = useState([]);

  const [time_period_payload, setTime_period_payload] = useState("");
  ...
  console.log("time period payload :", time_period_payload);
  return (
    <Data.Provider
      value={{
        employeeDetails,
