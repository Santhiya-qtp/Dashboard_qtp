...
const PermissionRequest = () => {
  const { perRequests, setPerRequests } = useContext(Data);
  ...
  useEffect(() => {
    const fetchPermissions = async () => {
      try {
        ...
        console.log("Permission req : ", allRequests)
      ...
      <div className="main-container">
        ...
        <div className="content-container mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
          {pendingRequests.length === 0 ? (
            <div className="no-requests-container mb-5 mt-4">
              <img
                src={emptyImg} // Replace with your image path
                  ...
                  <div className="card-container mt-3">
                    <table>
                      ...
                      <tr>
                        ...
                        <td className="pl-4">
                          {item.time_from.split(":").slice(0, 2).join(":")}
                        </td>
                      </tr>
                      <tr>
                        <td className="font-semibold">To: </td>
                        <td className="pl-4">
                          {item.time_to.split(":").slice(0, 2).join(":")}
                        </td>
                      </tr>
                    </table>
                  </div>
