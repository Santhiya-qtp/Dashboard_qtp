  ...
  return (
    <>
      <div className="main-container mt-4 grid grid-cols-2 sm:grid-cols-3 gap-2 md:grid-cols-4 col-span-12">
        ...
        <div className="container-1 bg-[#F5FAFD] h-[240px] rounded-xl px-4">
          <h1 className="m-auto w-fit mt-4 text-md font-medium ">
            Overall Team Attendance Percentage
            <img src={ring} className="m-auto w-[200px]" />
          </h1>
          <div className="celeberation-container translate-x-[-13px] mt-4 h-[200px]">
            <div className="mx-auto w-[305px] border h-[322px] rounded-xl overflow-auto hide-scrollbar">
