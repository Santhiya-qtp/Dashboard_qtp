...
const PermissionApproveModal = ({ approveDetails, closeApproveModal }) => {
  ...
  return (
    <>
      {success ? (
        <div className="bg-green-400 text-white font-semibold px-4 py-2 rounded-lg absolute z-[200] right-0 top-[15%]">
        ...
        <div className="card-container mt-3">
          <table>
            <tr>
              ...
              <td className="pl-4">{approveDetails.user_name}</td>
            </tr>
            <tr>
            ...
            <tr>
              {/* <td className="p-2">{row.time_from.split(':').slice(0, 2).join(':')}</td> */}
              <td className="font-semibold">From : </td>
              <td className="pl-4">{approveDetails.time_from.slice(0, 5)}</td>
            </tr>
            <tr>
              <td className="font-semibold">To: </td>
              <td className="pl-4">{approveDetails.time_to.slice(0, 5)}</td>
            </tr>
          </table>
          <button
