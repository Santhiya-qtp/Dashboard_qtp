            ...
            {filteredLeaves.length > 0 ? (
              filteredLeaves.map((leave, index) => (
                ...
                >
                  ...
                  <td className="py-3 px-2">{formatDate(leave.fromDate)}</td>
                  {/* <td className="py-3 px-2">{leave.toDate}</td> */}
                  <td className="py-3 px-2">{formatDate(leave.toDate)}</td>
                  ...
                  <td className="py-3 px-2 text-center">
                    <button
                      ...
                      className={`bg-[#E3F3FF] px-[8px] py-[9px] rounded-full hover:text-blue-700 ${
                        leave.status !== "Pending" ? "cursor-not-allowed " : ""
                      }`}
                      disabled={leave.status !== "Pending"}
                    >
                      <img src={eye} className="w-4" alt="View Details" />
                    </button>
                  </td>
                </tr>
              ))
